...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fartonium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fartonium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fartonium transaction") + "\n" +
              "  fartonium-tx [options] -create [commands]   " + _("Create hex-encoded fartonium transaction") + "\n" +
              "\n";
