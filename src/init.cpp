...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/fartonium-project/fartonium>";
    const std::string URL_WEBSITE = "<https://fartonium.org>";
